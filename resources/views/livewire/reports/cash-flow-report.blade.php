<div>
    <x-slot name="header">
        <h2 class="font-semibold text-base" style="color:#161e2d;">Laporan Arus Kas</h2>
    </x-slot>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-5">
            ...
            <div class="rounded-2xl p-6" style="background:linear-gradient(135deg,#ffffff 0%,#ffffff 62%);border:1px solid rgba(21,99,223,0.35);">
                <h1 class="text-2xl font-bold" style="color:#161e2d;font-family:'Manrope',serif;">Laporan Arus Kas</h1>
                <p class="text-sm mt-1" style="color:#161e2d;">Rekap pemasukan dan pengeluaran per periode</p>
            </div>
            ...
            <div class="rounded-2xl p-5" style="background:#ffffff;border:1px solid #e4e4e4;box-shadow:0 1px 2px rgba(21,99,223,0.04),0 8px 20px -8px rgba(21,99,223,0.06);">
                <h3 class="font-semibold text-sm mb-4" style="color:#161e2d;">Pilih Periode</h3>
                <div class="flex flex-wrap gap-4 items-end">
                    <div>
                        <label class="block text-xs font-medium mb-1.5" style="color:#5c6368;">Bulan</label>
                    ...
                    <div>
                        <label class="block text-xs font-medium mb-1.5" style="color:#5c6368;">Tahun</label>
                    ...
                    <div wire:loading wire:target="month,year,activeOrg" class="flex items-center gap-2 text-sm" style="color:#a3abb0;">
            ...
            @isset($this->reportData)
                ...
                <div class="text-center">
                    <p class="text-sm" style="color:#a3abb0;">
                        Periode: <span style="color:#5c6368;font-weight:500;">{{ \Carbon\Carbon::parse($rd['startDate'])->translatedFormat('d F Y') }}</span>
                        s/d <span style="color:#5c6368;font-weight:500;">{{ \Carbon\Carbon::parse($rd['endDate'])->translatedFormat('d F Y') }}</span>
                        &mdash; <span style="color:#161e2d;font-weight:500;">{{ $orgLabel }}</span>
                    </p>
                </div>
                ...
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    <div class="rounded-2xl p-5" style="background:#ffffff;border:1px solid #e4e4e4;box-shadow:0 1px 2px rgba(21,99,223,0.04),0 8px 20px -8px rgba(21,99,223,0.06);">
                        <p class="text-xs font-medium uppercase tracking-wide" style="color:#a3abb0;">Saldo Awal</p>
                        <p class="text-xl font-bold mt-1" style="color:#161e2d;">Rp {{ number_format($rd['startingBalance'], 0, ',', '.') }}</p>
                    </div>
                    <div class="rounded-2xl p-5" style="background:#ffffff;border:1px solid #e4e4e4;box-shadow:0 1px 2px rgba(21,99,223,0.04),0 8px 20px -8px rgba(21,99,223,0.06);">
                    ...
                    <div class="rounded-2xl p-5" style="background:#ffffff;border:1px solid #e4e4e4;box-shadow:0 1px 2px rgba(21,99,223,0.04),0 8px 20px -8px rgba(21,99,223,0.06);">
                        <p class="text-xs font-medium uppercase tracking-wide" style="color:#a3abb0;">Saldo Akhir</p>
                        <p class="text-xl font-bold mt-1" style="color:{{ $rd['endingBalance'] >= 0 ? '#1563df' : '#c0453b' }};">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div class="p-5">
                            @forelse($rd['incomeSummary'] as $item)
                                <div class="flex justify-between items-center py-2.5" style="border-bottom:1px solid #f7f7f7;">
                                    <span class="text-sm" style="color:#5c6368;">{{ $item->name }}</span>
                                    <span class="font-mono text-sm font-semibold" style="color:#12805c;">Rp {{ number_format($item->total, 0, ',', '.') }}</span>
                                </div>
                            @empty
                                <p class="text-sm text-center py-6" style="color:#a3abb0;">Tidak ada pemasukan pada periode ini.</p>
                            @endforelse
                            <div class="flex justify-between items-center pt-3 mt-2" style="border-top:2px solid #e4e4e4;">
                                <span class="text-sm font-bold" style="color:#161e2d;">TOTAL PEMASUKAN</span>
                    ...
                    <div class="rounded-2xl overflow-hidden" style="background:#ffffff;border:1px solid #e4e4e4;box-shadow:0 1px 2px rgba(21,99,223,0.04),0 8px 20px -8px rgba(21,99,223,0.06);">
                        ...
                        <div class="p-5">
                            ...
                            @empty
                                <p class="text-sm text-center py-6" style="color:#a3abb0;">Tidak ada pengeluaran pada periode ini.</p>
                            @endforelse
                            <div class="flex justify-between items-center pt-3 mt-2" style="border-top:2px solid #e4e4e4;">
                                <span class="text-sm font-bold" style="color:#161e2d;">TOTAL PENGELUARAN</span>
            ...
            @else
                <div class="rounded-2xl p-6 sm:p-10 text-center" style="background:#ffffff;border:1px solid #e4e4e4;box-shadow:0 1px 2px rgba(21,99,223,0.04),0 8px 20px -8px rgba(21,99,223,0.06);color:#a3abb0;">
