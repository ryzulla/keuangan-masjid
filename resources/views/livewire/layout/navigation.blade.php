            ...
            <div class="flex">
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-10">
                    <x-dropdown align="left" width="48">
                        ...
                        <x-slot name="content">
                            {{-- Pindahkan Manajemen Program ke sini --}}
                            <x-dropdown-link :href="route('transactions.index')" wire:navigate>
                                {{ __('Transaksi List') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('campaigns.index')" wire:navigate>
                                {{ __('Manajemen Program') }} {{-- <-- PINDAH KE SINI --}}
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        @can('manage-transactions')
            <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                <div class="px-4"><div class="font-medium text-base text-gray-800 dark:text-gray-200">Transaksi</div></div>
        ...
        @can('view-reports')
            <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                ...
                <div class="mt-3 space-y-1">
                    <x-responsive-nav-link :href="route('reports.cashflow')" :active="request()->routeIs('reports.cashflow')" wire:navigate>
                        {{ __('Laporan Arus Kas') }}
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('reports.balancesheet')" :active="request()->routeIs('reports.balancesheet')" wire:navigate>
                        {{ __('Neraca') }}
                    </x-responsive-nav-link>
                </div>
            </div>
        ...
        <!-- Menu Data Master (Mobile) -->
        @can('manage-transactions')
            <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                <div class="px-4"><div class="font-medium text-base text-gray-800 dark:text-gray-200">Data Master</div></div>
                <div class="mt-3 space-y-1">
