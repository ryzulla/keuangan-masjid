<div>
    <x-slot name="header">
        <h2 class="font-semibold text-base" style="color:#111827;">Pengaturan Tarif IPL</h2>
    </x-slot>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="rounded-2xl p-6" style="background:linear-gradient(135deg,#ffffff 0%,#ffffff 62%);border:1px solid rgba(16,24,40,0.35);">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        <h1 class="text-2xl font-bold" style="color:#111827;font-family:'IBM Plex Sans',serif;">Pengaturan Tarif IPL</h1>
                        <p class="text-sm mt-1" style="color:#111827;">Kelola jenis tarif dan nominal default untuk setiap periode IPL</p>
                    </div>
            ...
            {{-- Info Box --}}
            <div class="rounded-xl p-4 flex gap-3" style="background:rgba(16,24,40,0.06);border:1px solid rgba(16,24,40,0.2);">
                <svg class="w-5 h-5 shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="#111827" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                <div class="text-sm space-y-1" style="color:#111827;">
                    <p><span style="color:#111827;font-weight:600;">Tarif Sistem</span> (Keamanan &amp; Sampah) adalah tarif bawaan yang tidak bisa dihapus. Nominal defaultnya digunakan sebagai nilai awal saat membuat periode IPL baru.</p>
                    <p><span style="color:#111827;font-weight:600;">Tarif Tambahan</span> adalah iuran lain di luar keamanan dan sampah (contoh: Kebersihan Taman, Parkir, dll). Tarif ini akan otomatis ditambahkan sebagai item tagihan terpisah pada setiap billing blok.</p>
                </div>
            </div>
            ...
            <div class="rounded-2xl overflow-hidden" style="background:#ffffff;border:1px solid #e4e7ec;box-shadow:0 1px 2px rgba(16,24,40,0.04),0 8px 20px -8px rgba(16,24,40,0.06);">
                <div class="flex items-center justify-between px-5 py-4" style="background:#f2f4f7;border-bottom:1px solid rgba(16,24,40,0.2);">
                    <div class="flex items-center gap-3">
                        <div class="w-8 h-8 rounded-lg flex items-center justify-center" style="background:rgba(16,24,40,0.15);border:1px solid rgba(16,24,40,0.3);">
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="#111827" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>
                        </div>
                        <div>
                            <h3 class="font-semibold text-sm" style="color:#1d2939;">Tarif Sistem (Bawaan)</h3>
                            <p class="text-xs" style="color:#7c8698;">Tarif wajib — tidak dapat dihapus</p>
                        </div>
                    </div>
                    <span class="text-xs px-2.5 py-1 rounded-full" style="background:rgba(16,24,40,0.1);color:#1d2939;border:1px solid rgba(16,24,40,0.2);">{{ $systemTypes->count() }} tarif</span>
                </div>
                <div class="overflow-x-auto hidden md:block">
                    <table class="w-full text-sm">
                        <thead>
                            <tr style="background:#ffffff;border-bottom:1px solid #eef0f3;">
                                <th class="text-left px-5 py-3 text-xs font-semibold uppercase tracking-wider" style="color:#98a2b3;">No</th>
                                <th class="text-left px-5 py-3 text-xs font-semibold uppercase tracking-wider" style="color:#98a2b3;">Nama Tarif</th>
                                <th class="text-left px-5 py-3 text-xs font-semibold uppercase tracking-wider" style="color:#98a2b3;">Keterangan</th>
                                <th class="text-left px-5 py-3 text-xs font-semibold uppercase tracking-wider" style="color:#98a2b3;">Nominal Default</th>
                                <th class="text-center px-5 py-3 text-xs font-semibold uppercase tracking-wider" style="color:#98a2b3;">Sort</th>
                                <th class="text-center px-5 py-3 text-xs font-semibold uppercase tracking-wider" style="color:#98a2b3;">Status</th>
                        ...
                        <tbody>
                            @forelse($systemTypes as $i => $type)
                                <tr wire:key="sys-{{ $type->id }}" style="border-bottom:1px solid #ffffff;" onmouseover="this.style.backgroundColor='#f5f6f8'" onmouseout="this.style.backgroundColor=''">
                                    <td class="px-5 py-3.5" style="color:#98a2b3;">{{ $i + 1 }}</td>
                                    <td class="px-5 py-3.5">
                                        <div class="flex items-center gap-2">
                                            <span class="font-semibold" style="color:#1d2939;">{{ $type->name }}</span>
                                    ...
                                    <td class="px-5 py-3.5 text-sm" style="color:#7c8698;">{{ $type->description ?? '—' }}</td>
                                    <td class="px-5 py-3.5">
                                        <span class="font-mono font-semibold text-base" style="color:#111827;">Rp {{ number_format($type->default_amount, 0, ',', '.') }}</span>
                                        <p class="text-xs" style="color:#98a2b3;">/blok/bulan</p>
                                    </td>
                                    <td class="px-5 py-3.5 text-center text-sm" style="color:#98a2b3;">{{ $type->sort_order }}</td>
                                    <td class="px-5 py-3.5 text-center">
                                        ...
                                        @else
                                            <span class="inline-flex items-center gap-1 text-xs px-2.5 py-1 rounded-full" style="background:#f5f6f8;color:#98a2b3;border:1px solid #e4e7ec;">
                                                <span class="w-1.5 h-1.5 rounded-full inline-block" style="background:#cdd2da;"></span>Nonaktif
                                            </span>
                                        @endif
                                    </td>
                                    <td class="px-5 py-3.5">
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="px-5 py-8 text-center text-sm" style="color:#98a2b3;">Belum ada tarif sistem. Jalankan seeder.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
                ...
                <div class="md:hidden divide-y" style="border-color:#eef0f3;">
                        ...
                        <div wire:key="sys-card-{{ $type->id }}" class="p-4 space-y-3">
                            <div class="flex items-start justify-between gap-3">
                                <div>
                                    ...
                                    <p class="text-xs mt-0.5" style="color:#98a2b3;">{{ $type->description ?? '—' }}</p>
                                </div>
                                @if($type->is_active)
                                ...
                                @else
                                    <span class="inline-flex items-center gap-1 text-xs px-2.5 py-1 rounded-full shrink-0" style="background:#f5f6f8;color:#98a2b3;border:1px solid #e4e7ec;">
                                        <span class="w-1.5 h-1.5 rounded-full inline-block" style="background:#cdd2da;"></span>Nonaktif
                                    </span>
                                @endif
                            </div>
                            <div>
                                <span class="font-mono font-semibold text-base" style="color:#111827;">Rp {{ number_format($type->default_amount, 0, ',', '.') }}</span>
                                <p class="text-xs" style="color:#98a2b3;">/blok/bulan &middot; Sort {{ $type->sort_order }}</p>
                            </div>
                    ...
                    @empty
                        <div class="px-5 py-8 text-center text-sm" style="color:#98a2b3;">Belum ada tarif sistem. Jalankan seeder.</div>
                    @endforelse
                </div>
            </div>
            ...
            {{-- Tarif Tambahan --}}
            <div class="rounded-2xl overflow-hidden" style="background:#ffffff;border:1px solid #e4e7ec;box-shadow:0 1px 2px rgba(16,24,40,0.04),0 8px 20px -8px rgba(16,24,40,0.06);">
                <div class="flex items-center justify-between px-5 py-4" style="background:#ffffff;border-bottom:1px solid #eef0f3;">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="font-semibold text-sm" style="color:#1d2939;">Tarif Tambahan</h3>
                            <p class="text-xs" style="color:#98a2b3;">Iuran lain di luar keamanan &amp; sampah (kebersihan taman, parkir, dll)</p>
                        </div>
                    </div>
                    <span class="text-xs px-2.5 py-1 rounded-full" style="background:#f5f6f8;color:#7c8698;border:1px solid #e4e7ec;">{{ $extraTypes->count() }} tarif</span>
                </div>
                <div class="overflow-x-auto hidden md:block">
                    <table class="w-full text-sm">
                        <thead>
                        ...
                        <tbody>
                            @forelse($extraTypes as $i => $type)
                                <tr wire:key="extra-{{ $type->id }}" style="border-bottom:1px solid #ffffff;" onmouseover="this.style.backgroundColor='#f5f6f8'" onmouseout="this.style.backgroundColor=''">
                                    <td class="px-5 py-3.5" style="color:#98a2b3;">{{ $i + 1 }}</td>
                                    <td class="px-5 py-3.5">
                                        <div class="flex items-center gap-2">
                                            <span class="font-semibold" style="color:#1d2939;">{{ $type->name }}</span>
                                        ...
                                        <p class="text-xs mt-0.5" style="color:#98a2b3;">ipl_billing_charge_items</p>
                                    </td>
                                    <td class="px-5 py-3.5 text-sm" style="color:#7c8698;">{{ $type->description ?? '—' }}</td>
                                    <td class="px-5 py-3.5">
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="px-5 py-12 text-center" style="color:#98a2b3;">
                                        ...
                                        <p class="text-xs mt-1" style="color:#98a2b3;">Klik "Tambah Tarif Baru" untuk menambahkan iuran selain keamanan &amp; sampah.</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
                ...
                <div class="md:hidden divide-y" style="border-color:#eef0f3;">
                    ...
                    @empty
                        <div class="px-5 py-12 text-center" style="color:#98a2b3;">
                            <svg class="w-10 h-10 mx-auto mb-3 opacity-20" fill="none" viewBox="0 0 24 24" stroke="currentColor" style="color:#7c3aed;"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M12 6v6m0 0v6m0-6h6m-6 0H6"/></svg>
                            <p class="text-sm">Belum ada tarif tambahan.</p>
                            <p class="text-xs mt-1" style="color:#98a2b3;">Klik "Tambah Tarif Baru" untuk menambahkan iuran selain keamanan &amp; sampah.</p>
                        </div>
            ...
            <div class="rounded-2xl overflow-hidden" style="background:#ffffff;border:1px solid #e4e7ec;box-shadow:0 1px 2px rgba(16,24,40,0.04),0 8px 20px -8px rgba(16,24,40,0.06);">
                <div class="flex items-center gap-3 px-5 py-4" style="background:#f2f4f7;border-bottom:1px solid rgba(16,24,40,0.2);">
                    <div class="w-8 h-8 rounded-lg flex items-center justify-center" style="background:rgba(16,24,40,0.15);border:1px solid rgba(16,24,40,0.3);">
                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="#111827" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M3 10h18M7 15h1m4 0h1m-7 4h16a1 1 0 001-1V6a1 1 0 00-1-1H4a1 1 0 00-1 1v12a1 1 0 001 1z"/></svg>
                    </div>
                    <div>
                        <h3 class="font-semibold text-sm" style="color:#1d2939;">Akun Tujuan Pembayaran</h3>
                        <p class="text-xs" style="color:#7c8698;">Tentukan akun kas/bank yang menerima dana untuk setiap jenis tarif &amp; donasi</p>
                    </div>
                </div>
                ...
                <form wire:submit="saveAccounts" class="p-5 space-y-5">
                    {{-- Tarif Sistem --}}
                    <div>
                        <p class="text-xs font-semibold uppercase tracking-wider mb-2" style="color:#98a2b3;">Tarif Sistem</p>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                            @foreach($systemTypes as $type)
                                <div>
                                    <label class="block text-sm mb-1.5" style="color:#475467;">{{ $type->name }}</label>
                    ...
                    @if($activeExtraTypes->count())
                        <div>
                            <p class="text-xs font-semibold uppercase tracking-wider mb-2" style="color:#98a2b3;">Tarif Tambahan (Aktif)</p>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    {{-- Donasi --}}
                    <div>
                        <p class="text-xs font-semibold uppercase tracking-wider mb-2" style="color:#98a2b3;">Donasi</p>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                            <div>
                                <label class="block text-sm mb-1.5" style="color:#475467;">Donasi Perumahan</label>
                            ...
                            <div>
                                <label class="block text-sm mb-1.5" style="color:#475467;">Donasi DKM</label>
                    ...
                    {{-- Actions --}}
                    <div class="flex justify-end pt-2" style="border-top:1px solid #e4e7ec;">
                        <button type="submit"
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div class="relative rounded-2xl shadow-2xl w-full max-w-md overflow-hidden" style="background:#ffffff;border:1px solid #d0d5dd;" @click.stop>
            {{-- Modal Header --}}
            <div class="flex items-center justify-between px-6 py-4" style="background:#f2f4f7;border-bottom:1px solid rgba(16,24,40,0.35);">
                <h3 class="font-bold text-lg" style="color:#1d2939;font-family:'IBM Plex Sans',serif;">
            ...
            <form wire:submit="save" class="p-6 space-y-4">
                {{-- Nama --}}
                <div>
                    <label class="block text-sm font-medium mb-1.5" style="color:#475467;">Nama Tarif <span style="color:#c0453b;">*</span></label>
                ...
                {{-- Keterangan --}}
                <div>
                    <label class="block text-sm font-medium mb-1.5" style="color:#475467;">Keterangan <span class="text-xs" style="color:#98a2b3;">(opsional)</span></label>
                ...
                {{-- Nominal Default --}}
                <div>
                    <label class="block text-sm font-medium mb-1.5" style="color:#475467;">Nominal Default (Rp) <span style="color:#c0453b;">*</span></label>
                    <input type="number" wire:model="defaultAmount" min="0" step="500" placeholder="Contoh: 50000"
                        ...
                        style="background:#ffffff;border:1px solid #e4e7ec;color:#111827;"
                        onfocus="this.style.borderColor='#111827'" onblur="this.style.borderColor='#e4e7ec'">
                    <p class="text-xs mt-1" style="color:#98a2b3;">Nilai ini digunakan sebagai default saat membuat periode IPL baru. Bisa diubah per-periode.</p>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm font-medium mb-1.5" style="color:#475467;">Urutan (Sort)</label>
                    ...
                    <div class="flex items-end pb-1">
                        <label class="flex items-center gap-2.5 cursor-pointer select-none">
                            <input type="checkbox" wire:model="isActive" class="w-4 h-4 rounded" style="accent-color:#111827;">
                            <span class="text-sm" style="color:#475467;">Aktif</span>
                        </label>
                    </div>
                </div>
