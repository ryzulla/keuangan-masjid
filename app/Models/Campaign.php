...
use Illuminate\Database\Eloquent\Relations\HasMany as HasManyDirect;
...
class Campaign extends Model
{
    ...
    public function expenseTransactions(): HasManyDirect
    {
        return $this->hasMany(Transaction::class, 'campaign_id')->where('type', 'credit');
    }
