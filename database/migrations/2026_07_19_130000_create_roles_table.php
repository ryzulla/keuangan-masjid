...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::table('roles')->insert([
            ...
            ['key' => 'bendahara',   'label' => 'Bendahara',   'color' => '#6B5B95', 'group' => 'DKM Masjid',    'is_system' => true, 'sort' => 3, 'created_at' => $now, 'updated_at' => $now],
            ...
            ['key' => 'perumahan',   'label' => 'Perumahan',   'color' => '#A9741A', 'group' => 'Perumahan',     'is_system' => true, 'sort' => 6, 'created_at' => $now, 'updated_at' => $now],
